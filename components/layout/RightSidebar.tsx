            ...
            {mockUsers.slice(0, 4).map((user) => (
              <div key={user.id} className="flex items-center gap-3">
                ...
                <Button
                  ...
                  className="h-7 text-xs rounded-full shrink-0 border-brand-dark/20 text-brand-dark hover:bg-brand-dark hover:text-brand-lightest dark:border-brand-medium/30 dark:text-brand-medium dark:hover:bg-brand-medium dark:hover:text-brand-darkest"
                >
                  Follow
                </Button>
              </div>
